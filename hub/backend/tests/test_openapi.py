...
def test_openapi_exposes_phase_zero_paths() -> None:
    ...
    assert set(schema["paths"]) == {
        ...
        "/api/v1/namespaces/claims/{claim_id}",
        "/api/v1/namespaces/claims/{claim_id}/fail",
        "/api/v1/namespaces/claims/{claim_id}/revoke",
        "/api/v1/namespaces/claims/{claim_id}/verify",
