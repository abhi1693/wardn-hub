...
- For official MCP registry imports, confirm registryNamespace.verificationStatus is "imported", verificationMethod is "official_registry", and evidenceUrl points to the official registry record. Do not treat official registry provenance as namespace ownership verification.
