...
import type {
  ...
  McpServersInstallTelemetryParams,
...
export type mcpCatalogStatsResponse200 = {
  data: RegistryStatsResponse
  status: 200
}

export type mcpCatalogStatsResponseSuccess = (mcpCatalogStatsResponse200) & {
  headers: Headers;
};
;

export type mcpCatalogStatsResponse = (mcpCatalogStatsResponseSuccess)

export const getMcpCatalogStatsUrl = () => {




  return `http://localhost:8000/api/v1/mcp/catalog/stats`
}

/**
 * @summary Get Mcp Catalog Stats
 */
export const mcpCatalogStats = async ( options?: RequestInit): Promise<mcpCatalogStatsResponse> => {

  const res = await fetch(getMcpCatalogStatsUrl(),
  {
    ...options,
    method: 'GET'
  ...
  const data: mcpCatalogStatsResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as mcpCatalogStatsResponse
}
...
export type mcpServersInstallTelemetryResponse204 = {
  data: void
  status: 204
}

export type mcpServersInstallTelemetryResponse404 = {
  data: ErrorResponse
  status: 404
}

export type mcpServersInstallTelemetryResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type mcpServersInstallTelemetryResponseSuccess = (mcpServersInstallTelemetryResponse204) & {
  headers: Headers;
};
export type mcpServersInstallTelemetryResponseError = (mcpServersInstallTelemetryResponse404 | mcpServersInstallTelemetryResponse422) & {
  headers: Headers;
};

export type mcpServersInstallTelemetryResponse = (mcpServersInstallTelemetryResponseSuccess | mcpServersInstallTelemetryResponseError)

export const getMcpServersInstallTelemetryUrl = (serverName: string,
    params: McpServersInstallTelemetryParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `http://localhost:8000/api/v1/mcp/servers/telemetry/${serverName}?${stringifiedParams}` : `http://localhost:8000/api/v1/mcp/servers/telemetry/${serverName}`
}

/**
 * @summary Record Mcp Server Install Telemetry
 */
export const mcpServersInstallTelemetry = async (serverName: string,
    params: McpServersInstallTelemetryParams, options?: RequestInit): Promise<mcpServersInstallTelemetryResponse> => {

  const res = await fetch(getMcpServersInstallTelemetryUrl(serverName,params),
  {
    ...options,
    method: 'POST'
  ...
  const data: mcpServersInstallTelemetryResponse['data'] = body ? JSON.parse(body) : undefined
  return { data, status: res.status, headers: res.headers } as mcpServersInstallTelemetryResponse
}
