export type AgentBrandIconName =
  | "claude-code"
  | "codex"
  | "cursor"
  | "gemini-cli"
...
type AgentBrandIconProps = {
  name: AgentBrandIconName;
};

// Brand paths are vendored from Lobe Icons (MIT): https://github.com/lobehub/lobe-icons
export function AgentBrandIcon({ name }: AgentBrandIconProps) {
  if (name === "claude-code") {
    return (
      <svg aria-hidden="true" className="skill-agent-brand-icon" viewBox="0 0 24 24">
        <path
          clipRule="evenodd"
    ...
    return (
      <svg aria-hidden="true" className="skill-agent-brand-icon" viewBox="0 0 24 24">
        ...
        <path
          ...
          fill="url(#wardn-codex-gradient)"
        />
        <defs>
          <linearGradient id="wardn-codex-gradient" x1="12" x2="12" y1="3" y2="21">
    ...
    return (
      <svg aria-hidden="true" className="skill-agent-brand-icon" viewBox="0 0 24 24">
        <path
          ...
          fill="url(#wardn-gemini-cli-gradient)"
        />
        <path
          clipRule="evenodd"
        ...
        />
        <defs>
          <linearGradient id="wardn-gemini-cli-gradient" x1="24" x2="0" y1="6.587" y2="16.494">
