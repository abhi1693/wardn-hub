...
export async function GET() {
  ...
  const body = [
    ...
    "",
    "Wardn Hub is a community-driven MCP server directory and aggregator. It is not an MCP runtime, gateway execution plane, workspace installer, or Kubernetes runtime manager.",
    "",
    "## Canonical Indexes",
    "",
    `- Home: ${absoluteUrl("/")}`,
    ...
    "## Key Public Pages",
    "",
    `- Community MCP server directory: ${absoluteUrl("/")}`,
    ...
    "- Public server pages under /servers/{namespace}/{serverSlug} describe community-listed MCP servers, packages, remotes, categories, and documentation.",
