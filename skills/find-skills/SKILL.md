...
```sh
npx -y @wardn-ai/skills@0.1.1 --help
```
...
```sh
npx -y @wardn-ai/skills@0.1.1 search "playwright" --limit 8 --json
```

Only when the user explicitly scopes an owner, run:

```sh
npx -y @wardn-ai/skills@0.1.1 search "playwright" --owner "owner-name" --limit 8 --json
```
...
```sh
npx -y @wardn-ai/skills@0.1.1 audit "owner/repository/skill-slug" --json
```
...
```sh
npx -y @wardn-ai/skills@0.1.1 inspect "owner/repository/skill-slug" --json
```
...
```sh
npx -y @wardn-ai/skills@0.1.1 fetch-bundle \
...
```sh
npx -y @wardn-ai/skills@0.1.1 install \
  "owner/repository/skill-slug" \
  --hash "expected-64-character-hash" \
  --global \
  --agent codex \
...
```sh
npx -y @wardn-ai/skills@0.1.1 remove "skill-slug" --global --agent codex --yes --json
```
